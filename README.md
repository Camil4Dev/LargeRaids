...
- Version: 1.21.1
- Note: This Gradle build is API-only for Paper 1.21.11; NMS-specific features are disabled.
...
To build locally, install JDK 21 and Gradle 8+.
...
5. Run `gradle shadowJar` to build the jar file (named `LargeRaids.jar`) in `build/libs`
